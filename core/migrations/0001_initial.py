# Generated by Django 3.0.1 on 2020-05-21 01:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.FloatField(default=0)),
                ('longitude', models.FloatField(default=0)),
                ('placeId', models.CharField(blank=True, max_length=150, null=True)),
                ('types', models.CharField(blank=True, max_length=500, null=True)),
                ('main_type', models.CharField(default='establishment', max_length=100)),
