      ...
      <figure className={css(this.classes.figure)}>
        ...
        <img
          ...
          style={{
            ...
            transform: `rotate(${this.props.imgs[currImg].modifications.rotate ? this.props.imgs[currImg].modifications.rotate : 0}deg)`
          }}
        />
      </figure>
    )
  ...
  renderFooter (theme) {
    ...
    return (
      <Footer
        ...
        handleImageModification={this.props.handleImageModification}
      />
    )
  }
  renderSpinner () {
