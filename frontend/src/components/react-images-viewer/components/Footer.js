...
function Footer ({ caption, countCurr, countSeparator, countTotal, showCount, handleImageModification, theme, ...props }) {
  ...
  return (
    <div>
      <div className={css(classes.footer)} {...props} style={{flexWrap: "wrap"}}>
        {caption ? (
      ...
      <div style={{width: "100%", backgroundColor: "Red"}}>
        ...
        icon={"sync"} 
        style={{ margin: 5}} 
        onClick={(e) => {handleImageModification(e, countCurr - 1, {type: "rotate", value: 90})}}/>
      </div>
    </div>
  )
}
